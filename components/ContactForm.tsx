...
const ContactForm: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="w-full bg-green-500 -mt-8 mb-10 p-5 shadow-md rounded-md">
      ...
      <div className="md:flex md:items-center">
        <div className="md:w-1/3">
          <button
            className="shadow disabled:opacity-50 disabled:cursor-wait disabled:bg-green-500 bg-green-500 hover:bg-green-800 focus:shadow-outline focus:outline-none text-white py-3 px-6 rounded-md"
            type="submit"
